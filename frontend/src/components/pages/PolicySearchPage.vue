  ...
  <v-container>
    ...
    <div v-for="policy in ListSliced" :key=policy.id>
      <div class="policy_contents">
        ...
        <a @click="goService(policy.id)">{{policy.brief}}</a>
      </div>
    </div>
...
.policy_search_A_header,
.policy_search_B_header,
.policy_search_C_header {
  width: 100%;
  height: 15%;
  display: flex;
  justify-content: center;
...
.policy_search_A_content,
.policy_search_B_content,
.policy_search_C_content {
  width: 100%;
  height: 85%;
  display: flex;
  flex-wrap: wrap;
...
.policy_search_A_content div,
.policy_search_C_content div {
  width: 33% !important;
  cursor: pointer;
}
...
.policy_search_A_content img,
.policy_search_C_content img {
  width: 90% !important;
}
